...
I would have liked to talked about these other disciplines seperately too,
...
what we don't have to, obviously resulting in a performace boost, but this
isn't always the case. The real benefit with laziness is the ability to work
with infinities. The most common example probably being working infinite sets.
We can create define infinite sets, but only use parts of it when we need it.
...
\subsubsection{Haskell's type system}
