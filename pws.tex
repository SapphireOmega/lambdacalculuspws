...
the computer won't try to evaluate something untill it has to. If it were to
try to evaluate this function, it would become an infinitely long expression
\begin{align*}
	FAC:=\ &\lambda n.ISZERO\ n\ N1\ (MULT\ n\ (FAC\ (PRED\ n))) \\
...
our \(FAC\) function in lambda calculus.
\begin{align*}
	FAC:=\ &Y\ (\lambda fn.ISZERO\ n\ N1\ (MULT\ n\ (f\ (PRED\ n))))\\
	=\ &(\lambda f.(\lambda x.f(xx))\lambda x.f(xx))\\
	&\qquad(\lambda fn.(\lambda m.m(KF)T)\\
	&\qquad\qquad n\\
	&\qquad\qquad(\lambda ga.ga)\\
	&\qquad\qquad((\lambda mkg.m(kg))\\
	&\qquad\qquad\qquad n\\
	&\qquad\qquad\qquad(f((\lambda m.FST\ (m\ NEXT\ (PAIR\ N0\ N0)))n))))
\end{align*}

% todo: reduce fib function
