...
is create a world transformer, which is just an type synonym for a function
...
able to compose world transforms. We can't just compose them as we normally
would. I'd like to very quickly look at a small snippet in category theory.
Don't worry too much about what it means, I just want to represent visually the
fact that regular function composition and composition with these world
transforms is different.
...
But our world transforms don't follow each other, but we want to still be able
to compose them like this. (I will represent \texttt{WorldT} as T instead.)
\begin{center}
