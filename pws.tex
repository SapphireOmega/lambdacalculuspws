...
of type \texttt{Fn() -> i32}, which makes \texttt{lazy\_add} also of type
\texttt{Fn() -> i32}." A \texttt{Fn() -> i32} is just a function without
...
data structures as I hinted at earlier in this section.
